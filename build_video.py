...
# 2) Actually make the recordings (and put in raw/ subdirectory). Update segments.xlsx if necessary (internal timestamp headers). Update content file if necessary (subject tags, passage tags, video only sections).
# 3) Run remove_silence.py in the recording dir. Update segments.xlsx if necessary (internal timestamp times).
...
# 6) Push to website, make video public.
